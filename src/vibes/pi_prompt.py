...
PI_PROMPT_PREFIX = (
    ...
    "  PNG/JPEG/GIF/WebP/AVIF display inline; SVG files remain safe download attachments.\n"
    "  To render an SVG inline in a response, emit its markup in a fenced ```svg code block; Vibes sanitizes it and displays it as an inert image.\n"
