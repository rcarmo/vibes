...
class Config:
    ...
    def __init__(self):
        ...
        self.pi_response_timeout_s: int = _get_env_int("VIBES_PI_RESPONSE_TIMEOUT_S", 120)
        self.pi_agent_end_timeout_s: int = _get_env_int("VIBES_PI_AGENT_END_TIMEOUT_S", 30)
